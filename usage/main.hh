...
#endif
#define DEFAULT_NUMBER_OF_CONTEXT_WORDS 5
...
similarities --similarities (Calculates cosine similarities between word vectors of W1 W2 and displays in JSON format)\n"
